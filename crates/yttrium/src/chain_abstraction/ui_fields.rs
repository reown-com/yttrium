...
mod tests {
    ...
    fn jakub_case() {
        ...
        let initial_transaction = Transaction {
            ...
            gas_limit: U64::ZERO,
            input: bytes!(
                "a9059cbb000000000000000000000000228311b83daf3fc9a0d0a46c0b329942fc8cb2ed00000000000000000000000000000000000000000000000000000000001e8480"
            ),
            nonce: U64::ZERO,
        ...
        let route_transaction_1 = Transaction {
            ...
            input: bytes!(
                "095ea7b30000000000000000000000003a23f943181408eac424116af7b7790c94cb97a5000000000000000000000000000000000000000000000000000000000016cd3e"
            ),
            nonce: U64::from(0x29),
        ...
        let route_transaction_2 = Transaction {
            ...
            gas_limit: U64::from(0xf9e82),
            input: bytes!(
                ""
            ),
            nonce: U64::from(0x2a),
            chain_id: chain_id_1.clone(),
        };
