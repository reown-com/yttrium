...
mod tests {
    ...
    fn create_mock_storage_with_public_key() -> Arc<impl Storage> {
        ...
        impl Storage for MockStorageWithKey {
            ...
            fn set_verify_public_key(&self, _jwk: Jwk) -> Result<(), StorageError> {
                Ok(())
            }
            fn add_session(&self, _session: Session) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn delete_session(&self, _topic: Topic) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn get_session(&self, _topic: Topic) -> Result<Option<Session>, StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn get_all_sessions(&self) -> Result<Vec<Session>, StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            ...
            fn get_decryption_key_for_topic(&self, _topic: Topic) -> Result<Option<[u8; 32]>, StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn save_pairing(&self, _topic: Topic, _rpc_id: u64, _sym_key: [u8; 32], _self_key: [u8; 32]) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn get_pairing(&self, _topic: Topic, _rpc_id: u64) -> Result<Option<StoragePairing>, StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn save_partial_session(&self, _topic: Topic, _sym_key: [u8; 32]) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn insert_json_rpc_history(&self, _request_id: u64, _topic: String, _method: String, _body: String, _transport_type: Option<TransportType>) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn update_json_rpc_history_response(&self, _request_id: u64, _response: String) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn delete_json_rpc_history_by_topic(&self, _topic: String) -> Result<(), StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
            fn does_json_rpc_exist(&self, _request_id: u64) -> Result<bool, StorageError> {
                Err(StorageError::Runtime("unimplemented".to_string()))
            }
        }
    ...
    async fn test_handle_verify_no_attestation_valid_v2_response() {
        ...
        Mock::given(method("GET"))
            ...
            .respond_with(ResponseTemplate::new(200).set_body_json(VerifyAttestation {
