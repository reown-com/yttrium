...
internal interface UniffiLib : Library {
    ...
    fun uniffi_uniffi_yttrium_fn_method_accountclient_send_transaction(`ptr`: Pointer,`transaction`: RustBuffer.ByValue,
    ): Long
    ...
    fun uniffi_uniffi_yttrium_checksum_method_accountclient_send_transaction(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: UniffiLib) {
    ...
    if (lib.uniffi_uniffi_yttrium_checksum_method_accountclient_send_transaction() != 55347.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface AccountClientInterface {
    ...
    suspend fun `sendTransaction`(`transaction`: Transaction): kotlin.String
...
open class AccountClient: Disposable, AutoCloseable, AccountClientInterface {
    ...
    @Throws(Exception::class)
    @Suppress("ASSIGNED_BUT_NEVER_ACCESSED_VARIABLE")
    override suspend fun `sendTransaction`(`transaction`: Transaction) : kotlin.String {
        return uniffiRustCallAsync(
        callWithPointer { thisPtr ->
            UniffiLib.INSTANCE.uniffi_uniffi_yttrium_fn_method_accountclient_send_transaction(
                thisPtr,
