...
import 'package:yttrium_dart/i_yttrium_dart_client.dart';

class YttriumClient implements IYttriumClient {
  // Private constructor
  YttriumClient._internal();

  // Singleton instance
  static final YttriumClient _instance = YttriumClient._internal();

  // Public accessor for the singleton instance
  static YttriumClient get instance => _instance;
