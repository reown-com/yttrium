...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `FeeCompat`, `LocalAmountAccCompat`, `PrimitiveSignatureCompat`
