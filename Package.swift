...
let yttriumXcframeworkTarget: Target = useLocalRustXcframework ?
    ...
    .binaryTarget(
        name: "YttriumXCFramework",
        url: "https://github.com/reown-com/yttrium/releases/download/0.10.35/libyttrium.xcframework.zip",
        checksum: "a2066793191d20e6c0eb7aa0162babc99b804de0a42a1fb412a23c55f34493d3"
    )
...
let yttriumUtilsXcframeworkTarget: Target = useLocalRustXcframework ?
    ...
    .binaryTarget(
        name: "YttriumUtilsXCFramework",
        url: "https://github.com/reown-com/yttrium/releases/download/0.10.37/libyttrium-utils.xcframework.zip",
        checksum: "a9835899efe830b91b617844a0794db1ea003af4ee8aad586fbea83a4204abbb"
    )
