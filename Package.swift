...
let yttriumXcframeworkTarget: Target = useLocalRustXcframework ?
    ...
    .binaryTarget(
        name: "YttriumXCFramework",
        url: "https://github.com/reown-com/yttrium/releases/download/0.8.25/libuniffi_yttrium.xcframework.zip",
        checksum: "236a28121219882db51e0b9425c6cb567bc1ef5268fb5ea715280f0df5a55218"
    )
