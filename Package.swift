...
let yttriumXcframeworkTarget: Target = useLocalRustXcframework ?
    ...
    .binaryTarget(
        name: "YttriumXCFramework",
        url: "https://github.com/reown-com/yttrium/releases/download/0.10.44/libyttrium.xcframework.zip",
        checksum: "9a945b1c32862537f1a3c6a500d860bfe4f1835d23fba1b48ecbacec183e5cc8"
    )
...
let yttriumUtilsXcframeworkTarget: Target = useLocalRustXcframework ?
    ...
    .binaryTarget(
        name: "YttriumUtilsXCFramework",
        url: "https://github.com/reown-com/yttrium/releases/download/0.10.44/libyttrium-utils.xcframework.zip",
        checksum: "12d77cea75d095c2aa9131650d604dbfa378800566a73c0f5cbc4e89732d91ef"
    )
