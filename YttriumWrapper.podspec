...
s.prepare_command = <<-SCRIPT
  curl -L -o libuniffi_yttrium.xcframework.zip 'https://github.com/reown-com/yttrium/releases/download/0.9.23-stacks/libuniffi_yttrium.xcframework.zip'
